...
/**
 * NOVO: Gerencia a troca de tema (claro/escuro) e salva a preferência do usuário.
 */
function setupThemeManager() {
    ...
    // 1. Aplica o tema na carga inicial da página
    ...
    // 2. Adiciona o listener de clique para todos os botões de troca de tema
...
async function main() {
    ...
    try { // CORREÇÃO: A inicialização do Firebase foi movida para 'firebase-config.js' para evitar dependência circular.
        ...
        // NOVO: Configura o gerenciador de tema (claro/escuro)
        setupThemeManager();
