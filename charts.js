    ...
    charts.mainSalesChart = new Chart(ctx, {
        ...
        options: {
            ...
            scales: {
                y: {
                    beginAtZero: true,
                    ticks: { // Usa a função de utilidade para consistência na formatação de moeda
        ...
        options: {
            ...
            scales: {
                [valueAxis]: { // Configura o eixo de valores (x para horizontal, y para vertical)
                    beginAtZero: true,
                    ticks: {
                    callback: function(value) { // Usa a função de utilidade para consistência
                        if (isCurrency) {
    ...
    charts[canvasId] = new Chart(ctx, {
        ...
        options: {
            ...
            plugins: {
                legend: { position: 'top' },
                tooltip: {
                    callbacks: { // Usa a função de utilidade para consistência na formatação de moeda
